...
export default function MicrophoneIcon({ isMuted = false, isActive = false }: MicrophoneProps) {
    return (
        <div style={{ opacity: isActive ? 1 : 0, transition: "opacity 0.3s"}}>
            ...
            <line style={{ opacity: isMuted ? 1 : 0, transition: "opacity 0.1s"}} x1="100" y1="100" x2="380" y2="380" stroke="currentColor" stroke-width="25" stroke-linecap="round"></line>
